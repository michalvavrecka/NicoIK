...
def main():
    ...
    for i in range(40):
        ...
        if arg_dict["position"]:
            ...
            target_position = calibration_matrices.target_calibration_matrix(i)
    ...
    if arg_dict["save_statistics"]:
        filename = 'statistics/position_target.txt'
        ...
        filename = 'statistics/joint_diffs.txt'
